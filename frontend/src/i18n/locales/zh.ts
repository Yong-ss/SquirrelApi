export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 MYR 可获得多少 USD 余额',
        balanceRechargePreview: '预览：1 MYR = {usd} USD',
        rechargeFeeRate: '充值手续费率',
        rechargeFeeRateHint: '用户充值时额外收取的手续费百分比，0 表示不收取手续费',
        rechargeFeePreview: '预览：充值 100 MYR，手续费 {fee} MYR',
        orderTimeout: '订单超时时间',
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 MYR = {usd} USD',
    refundReason: '退款原因',
