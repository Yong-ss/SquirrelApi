export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD balance the user receives for each 1 MYR paid',
        balanceRechargePreview: 'Preview: 1 MYR = {usd} USD',
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 MYR = {usd} USD',
